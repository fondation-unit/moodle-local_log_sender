...
$string['settings:log_server_callback_token'] = 'LRS callback authentication token';
$string['settings:log_server_callback_token_desc'] = 'Shared secret token used to authenticate incoming callback requests from the external LRS server.';
